...
QT_MOC_LITERAL(5, 82, 8), // "hurry_up"
QT_MOC_LITERAL(6, 91, 15), // "enqueue_command"
QT_MOC_LITERAL(7, 107, 12), // "CommandNode*"
QT_MOC_LITERAL(8, 120, 21), // "enqueue_response_byte"
QT_MOC_LITERAL(9, 142, 22) // "build_working_response"

    },
    "ReceiveWorker\0command_received\0\0"
    "response_byte_received\0"
    "mcu_reset_message_received\0hurry_up\0"
...
void ReceiveWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ReceiveWorker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ReceiveWorker::hurry_up)) {
                *result = 3;
            }
        }
    }
