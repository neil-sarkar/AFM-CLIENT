define(["react", "jsx!pages/heatmap_canvas", "jsx!pages/line_profile", "jsx!pages/inline_scan_controls", "jsx!pages/number_input", "jsx!pages/dropdown", "jsx!pages/text_input", "jsx!pages/save_folder", "jsx!pages/scan_range_slider"], function(React, HeatmapCanvas, LineProfile, InlineScanControls, NumberInput, Dropdown, TextInput, SaveFolderPicker, ScanRangeSlider) {
    ...
    var empty_lateral_str = "data:image/png;base64,"
    ...
    var Scan = React.createClass({
        ...
        handle_new_lateral_bar_data: function(data) {
            this.update_lateral_bar("data:image/png;base64," + data);
        },
        update_lateral_bar: function(data) {
            var bar = $('.scan-lateral-scalebar');
            bar.data("imgsrc", data);
            bar[0].src = bar.data('imgsrc');
        },
        ...
        start_scanning: function(check_ok) {
            if(check_ok) {
                this.setState({
                    scanning: true,
                    initial_checks_in_progress: false,
        ...
        clear_scan: function() {
            ...
            setTimeout(function() {
                ...
                this.update_lateral_bar(empty_lateral_str);
                $('.scan-image-inverter').css({
                    "margin-top": 0,
                    "margin-bottom": "100%"
                });
        ...
        handle_level_change: function(e) {
            ...
            this.change_use_level(!this.state.use_level);
        },
        ...
        handle_auto_save_change: function(e) {
            scanner.set_use_auto_save(!this.state.auto_save);
            this.change_auto_save(!this.state.auto_save);
        },
        ...
        handle_save_png_change: function(e) {
            ...
            this.change_save_png(!this.state.save_png);
        },
        change_save_png: function(b_save_png) {
            this.setState({save_png: b_save_png});
        },
        handle_continuous_scan_change: function(e) {
            scanner.set_use_continuous_scan(!this.state.continuous_scan);
            this.change_continuous_scan(!this.state.continuous_scan);
        },
                    ...
                    <div className="left-flexbox flexbox-row">
                        ...
                        <div className="flex-column">
                            <div className="scan-lateral-container">
                                <img src={empty_lateral_str} className="scan-lateral-scalebar"/>
                            </div>
