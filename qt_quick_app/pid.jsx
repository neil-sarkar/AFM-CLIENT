		...
		render: function() {
			return (
				<div>
                                        ...
                                        <NumberInput value_type="pid" name="Setpoint" min={0} max={3.3} step={0.0001} round={4} notify_signal={pid.setpoint_changed} get_value={pid.setpoint} set_value={pid.set_setpoint} />
					<PIDEnabledSignal/>
