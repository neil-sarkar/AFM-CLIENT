			...
			return (
				<div className="wrapper" id="approach-wrapper">
					<div className="left-flexbox">
						<DataStreamGraph ref="approach_graph" dom_id="approach-graph" chart_title="Amplitude" data_update_signal={adc_5.value_changed} prompt_read={adc_5.read} num_points_displayed={Constants.Approach_Num_Points_Displayed} plotline_default={pid.setpoint} plotline_update_signal={pid.setpoint_changed} poll_rate={Constants.Approach_Poll_Rate}/>
