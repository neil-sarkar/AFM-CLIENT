...
QT_MOC_LITERAL(8, 118, 14), // "new_phase_data"
QT_MOC_LITERAL(9, 133, 20), // "set_stable_frequency"
QT_MOC_LITERAL(10, 154, 15), // "frequency_sweep"
QT_MOC_LITERAL(11, 170, 9), // "find_peak"
QT_MOC_LITERAL(12, 180, 18), // "initialize_machine"
QT_MOC_LITERAL(13, 199, 19) // "start_state_machine"
    ...
    "new_phase_data\0set_stable_frequency\0"
...
void Sweeper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->new_phase_data((*reinterpret_cast< QVariantList(*)>(_a[1]))); break;
        ...
        {
            typedef void (Sweeper::*_t)(QVariantList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Sweeper::new_phase_data)) {
                *result = 6;
            }
        }
    }
...
// SIGNAL 6
void Sweeper::new_phase_data(QVariantList _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
